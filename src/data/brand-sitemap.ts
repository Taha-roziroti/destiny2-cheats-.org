...
const defaultImages: BrandSitemapImage[] = [
	{
		src: '/images/destiny-2-cheats-esp.webp',
		title: 'Destiny 2 cheats esp',
		caption: 'Destiny 2 cheats esp wallhack',
	},
	{
		src: '/images/destiny-2-cheats-wallhack.webp',
		title: 'Destiny 2 cheats wallhack',
		caption: 'Destiny 2 cheats wallhack esp',
	},
	{
		src: '/images/destiny-2-cheats-aimbot.webp',
		title: 'Destiny 2 cheats aimbot',
		caption: 'Destiny 2 cheats aimbot soft aim',
	},
	{
		src: '/images/destiny-2-cheats-aimbot-view.webp',
		title: 'Destiny 2 cheats aimbot',
		caption: 'Destiny 2 cheats aimbot view',
	},
	{
		src: '/images/destiny-2-cheats-radar.webp',
		title: 'Destiny 2 cheats radar',
		caption: 'Destiny 2 cheats radar hack',
	},
	{
		src: '/images/destiny-2-cheats-raid.webp',
		title: 'Destiny 2 cheats',
		caption: 'Destiny 2 cheats in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Destiny 2', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'destiny-2-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'destiny-2-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Destiny 2 on PC' },
	...
	'crucible-cheats': { title: '{primaryKeyword} menu', caption: 'In-game menu for {primaryKeyword}' },
	'aim-assist': { title: '{primaryKeyword} soft aim', caption: 'Soft aim settings in {primaryKeyword}' },
	...
	'pve-cheats': { title: '{primaryKeyword} unlock guide', caption: 'Unlock tips with {primaryKeyword}' },
	...
	'affiliate-disclosure': { title: '{brand} affiliate disclosure', caption: 'Affiliate link disclosure for {primaryKeyword}' },
};
