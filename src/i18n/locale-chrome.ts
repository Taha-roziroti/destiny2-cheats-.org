...
export const commonChrome: Record<LocaleCode, CommonChrome> = {
	...
	pt: { selectLanguage: 'Selecionar idioma', breadcrumb: 'Trilha', browse: 'Navegar', skipToContent: 'Ir para o conteúdo principal', support: 'Suporte', privacy: 'Privacidade', terms: 'Termos', featureList: 'Lista de recursos', pricingPlans: 'Planos', buyerReviewsNav: 'Avaliações', forums: 'Fórum', blog: 'Fórum', officialResources: 'Recursos oficiais de Destiny 2', officialResourcesLead: 'Aprenda o jogo com referências oficiais e da comunidade:' },
	it: { selectLanguage: 'Seleziona lingua', breadcrumb: 'Percorso', browse: 'Sfoglia', skipToContent: 'Vai al contenuto principale', support: 'Supporto', privacy: 'Privacy', terms: 'Termini', featureList: 'Elenco funzioni', pricingPlans: 'Prezzi', buyerReviewsNav: 'Recensioni', forums: 'Forum', blog: 'Forum', officialResources: 'Risorse ufficiali Destiny 2', officialResourcesLead: 'Scopri il gioco con riferimenti ufficiali e della community:' },
	nl: { selectLanguage: 'Taal kiezen', breadcrumb: 'Broodkruimels', browse: 'Bladeren', skipToContent: 'Ga naar hoofdinhoud', support: 'Support', privacy: 'Privacy', terms: 'Voorwaarden', featureList: 'Functielijst', pricingPlans: 'Prijzen', buyerReviewsNav: 'Reviews', forums: 'Forum', blog: 'Forum', officialResources: 'Officiële Destiny 2-bronnen', officialResourcesLead: 'Leer het spel via officiële en community-bronnen:' },
	pl: { selectLanguage: 'Wybierz język', breadcrumb: 'Ścieżka', browse: 'Przeglądaj', skipToContent: 'Przejdź do treści', support: 'Wsparcie', privacy: 'Prywatność', terms: 'Regulamin', featureList: 'Lista funkcji', pricingPlans: 'Cennik', buyerReviewsNav: 'Opinie', forums: 'Forum', blog: 'Forum', officialResources: 'Oficjalne zasoby Destiny 2', officialResourcesLead: 'Poznaj grę dzięki oficjalnym i społecznościowym źródłom:' },
	ru: { selectLanguage: 'Выбрать язык', breadcrumb: 'Навигация', browse: 'Обзор', skipToContent: 'Перейти к содержимому', support: 'Поддержка', privacy: 'Конфиденциальность', terms: 'Условия', featureList: 'Список функций', pricingPlans: 'Цены', buyerReviewsNav: 'Отзывы', forums: 'Форум', blog: 'Форум', officialResources: 'Официальные ресурсы Destiny 2', officialResourcesLead: 'Изучайте игру по официальным и community-источникам:' },
	tr: { selectLanguage: 'Dil seç', breadcrumb: 'Konum', browse: 'Gözat', skipToContent: 'Ana içeriğe geç', support: 'Destek', privacy: 'Gizlilik', terms: 'Şartlar', featureList: 'Özellik listesi', pricingPlans: 'Fiyatlar', buyerReviewsNav: 'Yorumlar', forums: 'Forum', blog: 'Forum', officialResources: 'Resmi Destiny 2 kaynakları', officialResourcesLead: 'Oyunu resmi ve topluluk kaynaklarıyla öğrenin:' },
	ar: { selectLanguage: 'اختر اللغة', breadcrumb: 'مسار', browse: 'تصفح', skipToContent: 'انتقل إلى المحتوى الرئيسي', support: 'الدعم', privacy: 'الخصوصية', terms: 'الشروط', featureList: 'قائمة الميزات', pricingPlans: 'الأسعار', buyerReviewsNav: 'مراجعات', forums: 'المنتدى', blog: 'المنتدى', officialResources: 'مصادر Destiny 2 الرسمية', officialResourcesLead: 'تعلّم اللعبة من المصادر الرسمية والمجتمع:' },
	ja: { selectLanguage: '言語を選択', breadcrumb: 'パンくず', browse: '閲覧', skipToContent: 'メインコンテンツへスキップ', support: 'サポート', privacy: 'プライバシー', terms: '利用規約', featureList: '機能一覧', pricingPlans: '料金', buyerReviewsNav: 'レビュー', forums: 'フォーラム', blog: 'フォーラム', officialResources: 'Destiny 2 公式リソース', officialResourcesLead: '公式およびコミュニティの資料でゲームを学ぶ:' },
	ko: { selectLanguage: '언어 선택', breadcrumb: '경로', browse: '탐색', skipToContent: '본문으로 건너뛰기', support: '지원', privacy: '개인정보', terms: '약관', featureList: '기능 목록', pricingPlans: '요금', buyerReviewsNav: '리뷰', forums: '포럼', blog: '포럼', officialResources: 'Destiny 2 공식 리소스', officialResourcesLead: '공식 및 커뮤니티 자료로 게임을 배우세요:' },
	zh: { selectLanguage: '选择语言', breadcrumb: '导航路径', browse: '浏览', skipToContent: '跳到主要内容', support: '支持', privacy: '隐私', terms: '条款', featureList: '功能列表', pricingPlans: '价格', buyerReviewsNav: '买家评价', forums: '论坛', blog: '论坛', officialResources: 'Destiny 2 官方资源', officialResourcesLead: '通过官方和社区资料了解游戏：' },
	hi: { selectLanguage: 'भाषा चुनें', breadcrumb: 'ब्रेडक्रंब', browse: 'ब्राउज़', skipToContent: 'मुख्य सामग्री पर जाएँ', support: 'सहायता', privacy: 'गोपनीयता', terms: 'नियम', featureList: 'फ़ीचर सूची', pricingPlans: 'मूल्य', buyerReviewsNav: 'समीक्षाएँ', forums: 'फ़ोरम', blog: 'फ़ोरम', officialResources: 'आधिकारिक Destiny 2 संसाधन', officialResourcesLead: 'आधिकारिक और community संदर्भों से गेम सीखें:' },
	id: { selectLanguage: 'Pilih bahasa', breadcrumb: 'Jejak', browse: 'Jelajahi', skipToContent: 'Lewati ke konten utama', support: 'Dukungan', privacy: 'Privasi', terms: 'Ketentuan', featureList: 'Daftar fitur', pricingPlans: 'Harga', buyerReviewsNav: 'Ulasan', forums: 'Forum', blog: 'Forum', officialResources: 'Sumber resmi Destiny 2', officialResourcesLead: 'Pelajari game dari referensi resmi dan komunitas:' },
	th: { selectLanguage: 'เลือกภาษา', breadcrumb: 'เส้นทาง', browse: 'เรียกดู', skipToContent: 'ข้ามไปเนื้อหาหลัก', support: 'ช่วยเหลือ', privacy: 'ความเป็นส่วนตัว', terms: 'ข้อกำหนด', featureList: 'รายการฟีเจอร์', pricingPlans: 'ราคา', buyerReviewsNav: 'รีวิว', forums: 'ฟอรั่ม', blog: 'ฟอรั่ม', officialResources: 'แหล่งข้อมูล Destiny 2 อย่างเป็นทางการ', officialResourcesLead: 'เรียนรู้เกมจากแหล่งทางการและชุมชน:' },
	vi: { selectLanguage: 'Chọn ngôn ngữ', breadcrumb: 'Đường dẫn', browse: 'Duyệt', skipToContent: 'Chuyển đến nội dung chính', support: 'Hỗ trợ', privacy: 'Quyền riêng tư', terms: 'Điều khoản', featureList: 'Danh sách tính năng', pricingPlans: 'Giá', buyerReviewsNav: 'Đánh giá', forums: 'Diễn đàn', blog: 'Diễn đàn', officialResources: 'Tài nguyên Destiny 2 chính thức', officialResourcesLead: 'Tìm hiểu game qua nguồn chính thức và cộng đồng:' },
	uk: { selectLanguage: 'Обрати мову', breadcrumb: 'Навігація', browse: 'Огляд', skipToContent: 'Перейти до вмісту', support: 'Підтримка', privacy: 'Конфіденційність', terms: 'Умови', featureList: 'Список функцій', pricingPlans: 'Ціни', buyerReviewsNav: 'Відгуки', forums: 'Форум', blog: 'Форум', officialResources: 'Офіційні ресурси Destiny 2', officialResourcesLead: 'Вивчайте гру за офіційними та community-джерелами:' },
	cs: { selectLanguage: 'Vybrat jazyk', breadcrumb: 'Navigace', browse: 'Procházet', skipToContent: 'Přejít na hlavní obsah', support: 'Podpora', privacy: 'Soukromí', terms: 'Podmínky', featureList: 'Seznam funkcí', pricingPlans: 'Ceny', buyerReviewsNav: 'Recenze', forums: 'Fórum', blog: 'Fórum', officialResources: 'Oficiální zdroje Destiny 2', officialResourcesLead: 'Naučte se hru z oficiálních a komunitních zdrojů:' },
	ro: { selectLanguage: 'Selectează limba', breadcrumb: 'Traseu', browse: 'Răsfoiește', skipToContent: 'Sari la conținut', support: 'Suport', privacy: 'Confidențialitate', terms: 'Termeni', featureList: 'Listă funcții', pricingPlans: 'Prețuri', buyerReviewsNav: 'Recenzii', forums: 'Forum', blog: 'Forum', officialResources: 'Resurse oficiale Destiny 2', officialResourcesLead: 'Învățați jocul din surse oficiale și comunitare:' },
